...
{
    public partial class Listado_eventos2 : System.Web.UI.Page
    {
        ...
        private void GenerarCuerpoTablaDinamica(DataTable dt)
        {
            ...
            foreach (DataRow row in dt.Rows)
            {
                ...
                HtmlGenericControl tdProyectos = new HtmlGenericControl("td");
                HtmlAnchor linkProyectos = new HtmlAnchor();
                linkProyectos.InnerText = "Ver Proyectos";
                linkProyectos.Attributes["class"] = "btnProyectos";
                linkProyectos.HRef = $"Listado_Proyectos_info.aspx?id={row["id"]}&type=I";
                tdProyectos.Controls.Add(linkProyectos);
                tr.Controls.Add(tdProyectos);
